...
public class Board extends Subject  {
    ...
    public Board(int width, int height, @NotNull String boardName, int gameId) {
        ...
        //Top left wall.
        spaces[0][0].setFieldAction(new Wall(Heading.WEST));
        spaces[0][3].setFieldAction(new Wall(Heading.NORTH));
        spaces[1][3].setFieldAction(new Wall(Heading.NORTH));
        spaces[2][3].setFieldAction(new Wall(Heading.NORTH));
        spaces[3][3].setFieldAction(new Wall(Heading.NORTH));
        spaces[1][4].setFieldAction(new Checkpoint(1));



        spaces[2][5].setFieldAction(new Wall(Heading.NORTH));
        spaces[0][5].setFieldAction(new Wall(Heading.NORTH));
        ...
        //Bottom Left
        spaces[1][9].setFieldAction(new Checkpoint(2));
        spaces[1][8].setFieldAction(new Wall(Heading.NORTH));
        spaces[1][8].setFieldAction(new Wall(Heading.EAST));

        //Bottom left blocking wall
        spaces[0][10].setFieldAction(new Wall(Heading.SOUTH));
        spaces[1][10].setFieldAction(new Wall(Heading.SOUTH));
        spaces[2][10].setFieldAction(new Wall(Heading.SOUTH));
        spaces[3][10].setFieldAction(new Wall(Heading.SOUTH));




        //Top right
        spaces[10][0].setFieldAction(new Checkpoint(3));
        spaces[9][0].setFieldAction(new ConveyorBelt(1, Heading.WEST));
        spaces[9][1].setFieldAction(new ConveyorBelt(1, Heading.WEST));
        spaces[9][2].setFieldAction(new ConveyorBelt(1, Heading.WEST));

        //Bottom Right
        spaces[10][10].setFieldAction(new Wall(Heading.SOUTH));


        //Middle
        spaces[5][5].setFieldAction(new Checkpoint(4));
        spaces[5][3].setFieldAction(new ConveyorBelt(1, Heading.NORTH));
        spaces[5][7].setFieldAction(new ConveyorBelt(1, Heading.SOUTH));
        spaces[3][5].setFieldAction(new ConveyorBelt(1, Heading.WEST));
        spaces[7][5].setFieldAction(new ConveyorBelt(1, Heading.EAST));

        spaces[4][6].setFieldAction(new Gear(true));
        spaces[6][4].setFieldAction(new Gear(true));
        spaces[6][6].setFieldAction(new Gear(false));
        spaces[4][4].setFieldAction(new Gear(false));
